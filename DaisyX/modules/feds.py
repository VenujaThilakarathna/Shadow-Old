...
import DaisyX.modules.sql.feds_sql as sql
from DaisyX import DRAGONS, EVENT_LOGS, LOGGER, OWNER_ID, TIGERS, WOLVES, dispatcher
...
DELETEBTN_FED_HANDLER = CallbackQueryHandler(del_fed_button, pattern="rmfed_")
FED_OWNER_HELP_HANDLER = CommandHandler("fed_owner_help", fed_owner_help)
FED_ADMIN_HELP_HANDLER = CommandHandler("fed_admin_help", fed_admin_help)
FED_USER_HELP_HANDLER = CommandHandler("fed_user_help", fed_user_help)
FED_HELP = CommandHandler("fed_help", fed_help)
