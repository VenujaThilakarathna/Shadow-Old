...
FED_OWNER_HELP_HANDLER = CommandHandler(fed_owner_help, pattern="fed_owner_help")
FED_ADMIN_HELP_HANDLER = CommandHandler(fed_admin_help, pattern="fed_admin_help")
