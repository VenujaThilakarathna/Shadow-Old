...
4) If userbot joined enjoy music, If not add @Shadow_Helper to your group and retry
...
1) Make *@Mr_Shadow_Robot* admin of your channel 
...
2) Create a group with tittle: Channel Music: yourchannelid
3) Add bot as Channel admin with full perms
4) Add *@Mr_Shadow_Robot* to the channel as an admin.
